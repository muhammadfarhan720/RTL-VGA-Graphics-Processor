...
# ACDS 23.1 991 win32 2024.04.07.14:15:00
# ----------------------------------------
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock_generator.vo"
}
